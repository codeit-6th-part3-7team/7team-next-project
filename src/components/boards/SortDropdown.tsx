  ...
  return (
    <div className="relative">
      <div
        ...
        role="button"
        tabIndex={0}
        className="flex h-[45px] w-full items-center justify-between rounded-md border border-none bg-gray-100 px-5 py-[14px] text-center text-14 font-normal leading-[24px] text-gray-500 sm:w-[140px]"
      >
